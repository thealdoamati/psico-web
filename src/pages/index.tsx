      ...
      <section className="w-full mb-5 py-10 md:bg-gradient-to-r pt-7 pb-14 md:py-14 from-[#FFFFFF] to-[#EED6D3]">
        ...
        <div className="flex px-10 gap-10 md:gap-20 flex-col md:flex-row max-w-[1140px] justify-between items-center mx-auto">
          <div className="flex flex-col gap-5 lg:gap-4">
            ...
            <button className="btn_agendamento text-[12px] md:text-[16px] flex justify-center md:px-10 py-2 rounded-[20px] my-2 md:w-fit h-fit md:whitespace-nowrap text-white bg-[#00C449] hover:bg-[#137938] transition duration-500 font-semibold">
              <Link
